...
/*-----------------------------------------------------------------------------------*/
/* Emulacion de peticiones del módulo Kernel
/*-----------------------------------------------------------------------------------*/
/* 1) ABRIR_ARCHIVO-----------------------------*/
int abrir_archivo(char *nombreArchivo) {
    ...
    if (f==NULL) {
        ...
        datos[i++]='\0';
        printf("Se econtro el archivo:%s\n",datos);
        i=0;
        ch=fgetc(f);
        while (ch!='\n') {
            datos[i++]=ch;
        ...
        while (datos[i++]!='=');
        int j=0;
        int tope=strlen(datos)-i;
        for(j=0;j<tope;j++) numero[j]=datos[i+j];
        numero[j]='\0';
        int numeroReturn = atoi(numero);
        printf("Tamaño del archivo es:%d bytes\n",numeroReturn);
        return(numeroReturn);
    }
...
/* 3) TRUNCAR_ARCHIVO-----------------------------*/
int truncar_archivo(char *nombreArchivo) {
...
int main(int argc, char *argv[]) {
    ...
    /*------- Operaciones internas de prueba de filesystem -------*/
    if (argc==2) {
    ...
    /*------- Emulacion de peticiones del modulo kernel al filesystem -------*/
    if (argc==3) {
        if (!(strcmp(argv[1],"abrir_archivo"))) {
    ...
    /*------- Opciones de ejecucion con paso de parametro en main() -------*/
    if (!(parametrosCorrectos)) {
        ...
        printf("Abrir un archivo: ./filesystemv2.o abrir_archivo nombreArchivo\n\n");
        printf("Crear un archivo: ./filesystemv2.o crear_archivo nombreArchivo\n\n");
    }
